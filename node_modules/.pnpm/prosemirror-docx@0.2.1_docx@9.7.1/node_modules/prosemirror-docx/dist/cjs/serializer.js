...
class DocxSerializerState {
    ...
    image(src, widthPercent = 70, align = 'center', imageRunOpts) {
        ...
        this.current.push(new docx_1.ImageRun(Object.assign(Object.assign({}, imageRunOpts), { data: buffer, 
    ...
    table(node, opts = {}) {
        ...
        node.content.forEach((row) => {
            ...
            row.content.forEach((cell) => {
                ...
                cells.push(new docx_1.TableCell(Object.assign(Object.assign({}, tableCellOpts), ((getCellOptions === null || getCellOptions === void 0 ? void 0 : getCellOptions(cell)) || {}))));
            });
            rows.push(new docx_1.TableRow(Object.assign(Object.assign({}, ((getRowOptions === null || getRowOptions === void 0 ? void 0 : getRowOptions(row)) || {})), { children: cells, tableHeader })));
        });
        this.maxImageWidth = MAX_IMAGE_WIDTH;
        const table = new docx_1.Table(Object.assign(Object.assign({}, tableOptions), { rows }));
...
class DocxSerializer {
    ...
    serialize(content, options) {
        ...
        const doc = (0, utils_1.createDocFromState)(state);
        return doc;
    }
}
